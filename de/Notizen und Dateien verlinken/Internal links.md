...
While you can link to any of the [[Dateiformate|unterstützten Dateiformate]], links to file formats other than Markdown needs to include a file extension, such as `[[Figure 1.png]]`.
