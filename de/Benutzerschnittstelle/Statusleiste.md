...
Elemente in der Statusleiste können durch [[Übersicht|Integrierte Plugins]] oder [[Externe Erweiterungen]] hinzugefügt werden. Manche Elemente sind interaktiv, andere nur informativ.

Beispielsweise fügt die Erweiterung [[Anzahl der Wörter|Anzahl der Wörter]] die Wörter- und Zeichenanzahl in der Anzeige hinzu, die nicht anklickbar sind. Das [[Obsidian Sync/Einführung|Sync-Plugin]] hingegen fügt ein Symbol hinzu, das sowohl den Sync-Status anzeigt, als auch das Synchronisierungsprotokoll öffnet, wenn du es anklickst.
