...
aliases:
  ...
  - Linked pane
  - Pane layout
  - Benutzerschnittstelle/Use tabs in Obsidian
permalink: tabs
---
#TODO
...
Every tab belongs to a _tab group_. You can drag and drop tabs to rearrange them within a tab group, move them to a different tab group, or create a new tab group. On ![[lucide-monitor-check.svg#icon]] desktop, you can drag tabs out of their window to open them in a separate [[Pop-out Fenster|pop-out window]].
