...
Um Analysen auf deiner [[Einführung in Obsidian Publish|Obsidian Publish]]-Webseite zu verwenden, benötigst du eine [[Custom domains|eigene Domain]].
...
Du kannst die meisten Analysedienste über die Datei [[Customize your site|publish.js]] in deine Webseite einbinden. Ersetze dafür `yourdomain.com` durch deine eigene Domain und `src` mit dem entsprechenden Script des von dir verwendeten Analysedienstes.
