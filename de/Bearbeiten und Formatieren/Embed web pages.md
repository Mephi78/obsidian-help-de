...
To embed a YouTube video, use the same Markdown syntax as [[Formatierungsgrundlagen#Externe Bilder|external images]]:
...
To embed a tweet, use the same Markdown syntax as [[Formatierungsgrundlagen#Externe Bilder|external images]]:
