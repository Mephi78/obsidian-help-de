...
1. Drag and drop files or folders into the [[Dateiexplorer]] window
...
Obsidian uses [[Obsidian Flavored Markdown]]. Some apps use slightly different Markdown syntax. You can use [[Importprogramm für Markdown Format]] to convert your files to Obsidian's Markdown syntax. 
