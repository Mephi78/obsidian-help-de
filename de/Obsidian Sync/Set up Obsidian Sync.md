...
- **Recommended**: A [[Sichere deinen Vault|backup system]] in place for your Obsidian files. A syncing service is not a backup. 
...
- Sync enabled within the [[Übersicht]] settings. 
...
- **Recommended**: A [[Sichere deinen Vault|backup system]] in place for your Obsidian files on your most-used device. A syncing service is not a backup. 
