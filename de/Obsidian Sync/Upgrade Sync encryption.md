...
Before you proceed, create a [[Sichere deinen Vault|backup]] of your vault to prevent any potential data loss. This process will permanently delete all data in your remote vault with the old encryption, including the version history.

> [!danger] Migrations are destructive
> 
> **Always [[Sichere deinen Vault|back up]] your vault before proceeding with a migration.**
> 
