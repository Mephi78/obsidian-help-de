...
| `task:`         | Find matches in a [[Formatierungsgrundlagen#Aufgabenlisten\|task]] on a block-by-block basis.<p/>Example: `task:call`.                                                                                                                                                                                                 |
| `task-todo:`    | Find matches in an *uncompleted* [[Formatierungsgrundlagen#Aufgabenlisten\|task]] on a block-by-block basis.<p/>Example: `task-todo:call`.                                                                                                                                                                             |
| `task-done:`    | Find matches in a *completed* [[Formatierungsgrundlagen#Aufgabenlisten\|task]] on a block-by-block basis.<p/>Example: `task-done:call`.                                                                                                                                                                                |
