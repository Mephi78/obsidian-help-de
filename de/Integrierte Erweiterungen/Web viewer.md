...
External links open as a [[Tabs|tab]] which you can rearrange, split, and open in a [[Pop-out Fenster|pop-out window]]. Any web page cards embedded in [[Canvas]] files can be opened as web viewer tabs.
