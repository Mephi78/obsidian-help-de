...
---
#TODO
Note composer is a [[Übersicht|core plugin]] that lets you merge two notes or extract part of a note into a new note.
...
> [!tip]
> By default, Note composer asks you to confirm when merging notes. If you disable the confirmation, and you merge a note by mistake, you can still recover it with the [[Datenwiederherstellung]] plugin.
...
1. While in the **Editing view**, select the text you want to extract.
2. Open the [[Befehlspalette]].
3. Select **Note composer: Extract current selection...**.
4. Select the note you want to extract into.

> [!tip]
> By default, Note composer replaces the extracted text with a link to the destination note. Under settings, you can also change to instead [[Dateien einbetten|embed]] the destination note, or to leave nothing behind.
