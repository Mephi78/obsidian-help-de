...
Use the `...` icon in the [[Obsidian Web Clipper/Einführung|Web Clipper]] extension to access the current page variables for use in templates. There are five types of variables you can use:
