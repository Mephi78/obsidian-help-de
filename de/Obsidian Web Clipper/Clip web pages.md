...
---
#TODO
Once you install the [[Einführung in Obsidian Web Clipper|Web Clipper]] browser extension, you can access it in several ways, depending on your browser:
...
2. **Properties** shows the [[Eigenschaften|metadata]] extracted from the page that will be saved as [[Eigenschaften]] in Obsidian.
