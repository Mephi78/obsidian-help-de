...
---
#TODO
Functions are used in [[Introduction to Bases|Bases]] to manipulate data from [[Eigenschaften]] in filters and formulas. See the [[Bases syntax|bases syntax]] reference to learn more about how you can use functions.
